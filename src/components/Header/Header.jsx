      ...
      <header className="header-package row">
        ...
        <div className="package-search">
          <div className="search-bar">
            <form action="" className="search-form row">
      ...
      <div className="sidebar">
        <div className="site-sidebar d-flex" id="menu-toggle">
          ...
          <div className="sidebar-menu">
            ...
            <a href=".." className="sidebar-link pro-highlight">
              Fiverr Pro
            </a>
            <a href=".." className="sidebar-link highlight">
              Fiverr Business
            </a>
            <div className="menu-header">
              <h6 className="tbody-6">General</h6>
            </div>
            <a href=".." className="sidebar-link">
              Home
            </a>
        ...
        <div
          ...
          id="menu-overlay"
          onClick={() => {
            document.getElementById("menu-toggle").style.left = "-272px";
      ...
      <div className="header-category">
        <nav className="category-menu">
          <button className="button-right">
            <span style={{ width: 15, height: 15, fill: "rgb(122, 125, 133)" }}>
              <svg
                width={8}
                height={16}
                viewBox="0 0 8 16"
